...
/// @nodoc
@JsonSerializable()
class _$CloudsModelImpl extends _CloudsModel {
  _$CloudsModelImpl({@JsonKey(name: 'all') required this.all}) : super._();
...
abstract class _CloudsModel extends CloudsModel {
  factory _CloudsModel({@JsonKey(name: 'all') required final int all}) =
      _$CloudsModelImpl;
  _CloudsModel._() : super._();
